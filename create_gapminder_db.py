...
class CreateGapminderDB:
        ...
        def create_database(self):
            ...
            CREATE VIEW plotting AS 
             SELECT geography.name AS 'country_name',      -- 國家名稱
                   gdp_per_capita.time AS 'dt_year',         -- 年份
                   gdp_per_capita.gdp_pcap AS 'gdp_per_capita', -- 人均 GDP
                   geography.world_4region AS 'continent',   -- 所屬大洲
                   life_expectancy.lex AS 'life_expectancy',  -- 預期壽命
